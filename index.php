...
<html>
   <head>
      <title>Online Art Gallery Studio</title>
      <meta charset="utf-8" />
   ...
   <body>
      ...
      <header id="header" class="alt" >
         <div class="logo"><a href="index.php">Online <span>Art Gallery Studio</span></a></div>
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Design & Develop By Sanjana KM  |</div>
            &copy; Online Art Gallery Studio. All rights reserved.
         </div>
      </footer>
      <!-- Scripts -->
